...
var notification_repository_1 = require("../../application/repositories/notification-repository");
    ...
    DatabaseModule = __decorate([
        (0, common_1.Module)({
            providers: [
                ...
                {
                    provide: notification_repository_1.NotificationRepository,
                    useClass: prisma_notifications_repository_1.PrismaNotificationsRepository
                },
            ],
            exports: [notification_repository_1.NotificationRepository]
        })
    ], DatabaseModule);
